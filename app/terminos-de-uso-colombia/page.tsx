...
export const metadata: Metadata = {
  ...
  description:
    'Términos de Uso y Contrato de Mandato entre Eventezer y los organizadores de eventos en Colombia.',
};
...
const TOC: Array<[string, string]> = [
  ...
  [
    '#naturaleza-mandato',
    '2. Naturaleza de la relación: mandato mercantil y recaudo por cuenta de terceros',
  ],
    ...
    >
      ...
      <section id="naturaleza-mandato">
        ...
        <p>
          ...
          <strong className="text-foreground">contrato de mandato mercantil</strong>, en los
          términos de los artículos 1262 a 1286 del Código de Comercio colombiano: el Organizador
      ...
      <section id="obligaciones-organizador">
        ...
        <ol className="ml-5 list-decimal space-y-2 text-muted-foreground">
          ...
          <li>
            Cumplir con toda la normativa aplicable a la realización de espectáculos públicos y con
            el Estatuto del Consumidor (Ley 1480 de 2011) en lo relativo a la venta de entradas a
      ...
      <section id="comision-liquidacion">
        ...
        <p className="mb-3">
          ...
          Plataforma para Colombia (montos en pesos colombianos, COP). Las órdenes pendientes,
          rechazadas o canceladas no generan comisión.
        </p>
      ...
      <section id="cancelaciones">
        ...
        <p className="text-muted-foreground">
          ...
          aplicable a los Compradores (incluyendo el derecho de retracto cuando resulte aplicable
          bajo el Estatuto del Consumidor), es responsabilidad exclusiva del Organizador.{' '}
          {SERVICE_NAME} facilita los medios técnicos para procesar reembolsos cuando el Organizador
          así lo indique, pero no garantiza ni se hace responsable por la devolución de fondos ya
      ...
      <section id="proteccion-datos">
        ...
        <p className="text-muted-foreground">
          El tratamiento de los datos personales de Compradores y Organizadores en Colombia se rige
          por el{' '}
          <a href="/politica-de-privacidad-colombia" className="text-primary hover:underline">
            Aviso de Privacidad / Habeas Data
          </a>{' '}
          de {SERVICE_NAME}, elaborado conforme a la Ley 1581 de 2012, el cual forma parte integral
      ...
      <section id="ley-aplicable">
        ...
        <p className="text-muted-foreground">
          Este documento se rige por las leyes de la República de Colombia, en particular el Código
          de Comercio (mandato mercantil), la Ley 527 de 1999 (comercio electrónico) y la Ley 1480
          de 2011 (Estatuto del Consumidor) en lo que resulte aplicable. Para cualquier controversia
          derivada de su interpretación o ejecución, las partes se someten a los jueces competentes
          de Colombia, salvo que acuerden un mecanismo alternativo conforme a la sección siguiente.
        </p>
      </section>
      ...
      <section id="resolucion-conflictos">
        ...
        <p className="text-muted-foreground">
          ...
          previstos en la legislación colombiana, incluyendo los centros de conciliación y arbitraje
